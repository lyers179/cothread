...
/**
 * @file spawn.hpp
 * @brief Task spawning functions for the bthread library.
 *
 * This header provides functions to spawn bthread tasks and coroutines:
 * - spawn(): Spawn a function as a bthread task
 * - spawn_bthread(): Explicitly spawn a bthread
 * - spawn_coro(): Spawn a coroutine task
 * - spawn_detached(): Spawn a fire-and-forget task
 * - current_task_id(): Get current task ID
 * - yield(): Yield the current task
 */
